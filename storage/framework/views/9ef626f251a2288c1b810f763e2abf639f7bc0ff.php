    ...
    <form action="<?php echo e(route('employees.update', $employee)); ?>" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="mb-4">
                ...
                <input id="employee_id" type="text" name="employee_id" value="<?php echo e(old('employee_id', $employee->employee_id)); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name', $employee->name)); ?>" required
                      class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-200">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input id="email" type="email" name="email" value="<?php echo e(old('email', $employee->email)); ?>" required
                      class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-200">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input id="dob" type="date" name="dob" value="<?php echo e(old('dob', $employee->dob->format('Y-m-d'))); ?>" required
                      class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-200">
                <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input id="doj" type="date" name="doj" value="<?php echo e(old('doj', $employee->doj->format('Y-m-d'))); ?>" required
                      class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-200">
                <?php $__errorArgs = ['doj'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEVELOP\PHP\employee-management\resources\views/employees/edit.blade.php ENDPATH**/ ?>